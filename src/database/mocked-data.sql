...
(1, 'Java Cafe', 'Twoja codzienna dawka kofeiny', '123-456-7890', 'Popularna kawiarnia z szeroką gamą kaw i ciast.', 1, '', 10, 50, 1, '08:00', '22:00'),
(2, 'Tech Gadgets', 'Zainnowuj swoje życie', '321-654-0987', 'Sklep z najnowszą techniką i gadżetami.', 1, '', 50, 500, 2, '09:00', '21:00'),
(3, 'Art Gallery', 'Odkryj piękno sztuki', '555-123-4567', 'Galeria prezentująca dzieła lokalnych i międzynarodowych artystów.', 1, '', 20, 200, 7, '10:00', '18:00'),
(1, 'Super Gym', 'Twój nowy wymiar fitness', '321-987-6543', 'Nowoczesne centrum fitness z profesjonalnym sprzętem i osobistymi trenerami.', 1, '', 15, 100, 8, '05:00', '23:00'),
(3, 'The Book Worm', 'Escape in Pages', '777-888-9999', 'Cozy bookstore offering a wide range of titles and genres.', 3, '', 5, 40, 1, '09:00', '20:00'),
(2, 'Gamer’s Den', 'Live the Game', '888-999-7777', 'Ultimate destination for gamers - latest titles, accessories, and gaming setups.', 1, '', 30, 300, 2, '10:00', '00:00'),
(1, 'Urban Eats', 'Dine in Style', '999-777-8888', 'Modern restaurant serving urban cuisine with a local twist.', 2, '', 20, 150, 1, '12:00', '23:00');
...
INSERT INTO coupon (branch_id, title, description, lifespan_in_minutes) VALUES
